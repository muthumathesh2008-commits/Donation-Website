            ...
            {step === 1 && (
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="text-center space-y-2">
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">Choose an Amount</h2>
                  <p className="text-slate-500">Every contribution helps us make a difference.</p>
                </div>
